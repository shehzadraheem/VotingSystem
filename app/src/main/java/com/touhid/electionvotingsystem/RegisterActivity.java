...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resendCode = findViewById(R.id.resendTV);
        codeDes = findViewById(R.id.codeDes);
        alreadyLoginBtn = findViewById(R.id.reglogbtn);

        alreadyLoginBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent register = new Intent(RegisterActivity.this, HaveAccountActivity.class);
    ...
    private void signInWithPhoneAuthCredentials(PhoneAuthCredential credential) {
        ...
        mAuth.signInWithCredential(credential).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(RegisterActivity.this, "There are some error in credential you provided", Toast.LENGTH_SHORT).show();
            }
        });
    }
