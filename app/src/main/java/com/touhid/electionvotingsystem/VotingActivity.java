...
public class VotingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra("CandId") &&
            ...
            Glide.with(this).load(candImage).into(mcand_image);
            mcandSpeech.setText(candSpeech);
            mcandPost.setText(candPost);
    ...
    private void vote(){
        ...
        mcastvotebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                voteuserMap.put("Finish", finish);


                Map<String, Object> voteMap = new HashMap<>();
                voteMap.put("candidatePost", mcandPost.getText());
                voteMap.put("deviceIp", getDeviceIP());
