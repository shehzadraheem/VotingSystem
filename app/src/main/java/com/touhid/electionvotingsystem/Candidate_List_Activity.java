...
public class Candidate_List_Activity extends AppCompatActivity {
   ...
   // private FirebaseAuth mAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCandidate_List_View = findViewById(R.id.candidate_list_view);
        mCandidate_btn = findViewById(R.id.candidate_btn);
        candidateRecyclerAdapter = new CandidateRecyclerAdapter(candidate_list);
        mCandidate_List_View.setLayoutManager(new LinearLayoutManager(this));
       ...
       // if(firebaseAuth.getCurrentUser() != null)
        if(currentUser_id != null)
        {
            ...
            Query firstQuery = firebaseFirestore.collection("Candidates")
            ...
            firstQuery.addSnapshotListener(this, new EventListener<QuerySnapshot>() {
                ...
                public void onEvent(QuerySnapshot documentSnapshots, FirebaseFirestoreException e) {
                    ...
                    if (!documentSnapshots.isEmpty()) {
                        ...
                        Toast.makeText(Candidate_List_Activity.this, "No Candidate available", Toast.LENGTH_SHORT).show();
                    }
                }
            });
